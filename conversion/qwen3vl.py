...
class Glm4VVisionModel(Qwen3VLVisionModel):
    def set_gguf_parameters(self):
        ...
        # smart_resize bounds: size.{shortest_edge,longest_edge} carry the min/max
        # pixel area; accept min_pixels/max_pixels for configs that spell them out
        ...
        if min_pixels is None or max_pixels is None:
            raise KeyError("GLM4V preprocessor_config is missing image pixel bounds (min_pixels/max_pixels or size.shortest_edge/longest_edge)")
